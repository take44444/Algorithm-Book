...
※パスクエリというのは，あるパスについて，与えられた2項演算(以降便宜上仮に"和"と呼ぶ)で，通った順番にノード上の値(以降便宜上整数とする)を累積していって得られる値を求めるクエリのことです．
...
この木を例にしながら，**任意の点から根までのパスにいくつのheavyパスが含まれるか**を考える．ノード1個単体で，どこにもheavy辺が伸びていないものも1つのheavyパスとみなすと，任意のパスにおいて，heavyパスと1本light辺を交互に通ることになる．そのため，パス上のheavyパスの個数とパス上のlight辺の個数の差は必ず\\(1\\)以下になる．つまり，**パス上のheavyパスの個数を抑えることは，パス上のlight辺の個数を抑えることと言い換えることができる**．
